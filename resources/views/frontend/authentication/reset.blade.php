        ...
        <div class="right-content">
            <form action="{{ route('password.reset') }}" method="post" class="authentication-form px-lg-5 forgot-form">
                ...
                <div class="authentication-form-header">
                    <h3 class="form-title my-2">Password Reset</h3>
                    <p class="form-des my-2">Please enter the code we emailed you.</p>
                </div>
                ...
                <div class="authentication-form-footer">
                    <p class="my-2">Didn’t receive the email? Click to <a href="{{ route('resend.otp') }}">resend </a></p>
                    <p class="my-2">Back to <a href="{{ route('login') }}">Log in </a></p>
                </div>
            </form>
        </div>
    </section>
